...
def daysim_popsampler(statepe):
    ...
    for district in districts:
        zone_district.loc[zone_district['district'] == district, 'sample_rate'] = state.input_settings.pop_sample_district[district][option-1] #option-1, as index starts from 0
...
if __name__ == "__main__":
    # Set up logging
    logger = logcontroller.setup_custom_logger("main_logger", r"piercecast_log.txt")
