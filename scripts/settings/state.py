...
class EmmeSettings(BaseModel):
    log_file_name: str
    USE_PIERCECAST_STOPTHRESH_STRATEGY: bool # Option to choose strategy 1 or 2 for convergence
    STOP_THRESHOLD: float  # Strategy 1 - Global convergence criteria; Strategy 2 - Pierce County convergence criteria
    STOP_THRESHOLD_REST: float  # Strategy 2 - Remaining Counties convergence criteria
