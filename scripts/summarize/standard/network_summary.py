...
def calc_total_vehicles(state, project):
    ...
    project.network_calculator("link_calculation", result='@vmt', expression='@tveh * length')
    project.network_calculator("link_calculation", result='@vht', expression='@tveh * timau / 60')
