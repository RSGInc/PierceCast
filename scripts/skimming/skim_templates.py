...
assignment_spec_class = (
    {
        "mode": "",
        "demand": "",
        "generalized_cost": {"link_costs": "", "perception_factor": ""},
    },
)
...
attribute_based_skim_spec = {
    ...
    "path_analysis": {
        ...
        "turn_component": None,
        "operator": "+",
        "selection_threshold": {"lower": 0, "upper": 999999},
        "path_to_od_composition": {"considered_paths": "ALL", "operator": "average"},
    },
...
attribute_based_skim_spec_class = (
    {
        "results": {
            "od_travel_times": {"shortest_paths": None},
            "link_volumes": None,
            "turn_volumes": None,
        },
        "analysis": {
